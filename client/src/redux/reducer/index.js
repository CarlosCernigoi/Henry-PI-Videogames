...
import { GET_ALL_VIDEOGAMES, GET_VIDEOGAME_DETAILS, CREATE_VIDEOGAME, GET_GENRES } from "../actions";
import { FILTER_ORIGIN, FILTER_GENRE, ORDER_BY_NAME, ORDER_BY_RATING, ORDER_BY, SEARCH_BY_NAME } from "../actions";
    ...
    switch (action.type) {
        ...
        case FILTER_ORIGIN:
            ...
            if (state.videoGames.length > 0) {
                return {
                    ...state,
                    videoGames: action.payload === 'all' ? state.allVideogames : filterOrigin
                }
            } /* else {
                return {
                    ...state,
        ...
        case FILTER_GENRE:
            state.videoGames = [...state.allVideogames]
            const filterGenre = state.videoGames.filter(vg => vg.genres && vg.genres.includes(action.payload))
        ...
        case ORDER_BY:
            ...
            return {
                ...state,
                videoGames: action.payload === 'disordered' ? state.allVideogames : orderedBy
            };
        case SEARCH_BY_NAME:
            return {
                ...state,
